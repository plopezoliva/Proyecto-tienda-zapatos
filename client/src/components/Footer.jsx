...
const Footer = () => {
    ...
    <div className=" container1 mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <div  className="flex items-center ">
                  <img src={zapatos} className="h-8 mr-3" alt="FlowBite Logo" />
                  <h1 className="self-center text-base font-medium  whitespace-nowrap text-gray-50">Zapatero</h1>
              </div>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mb-6 text-sm font-semibold text-gray-50 uppercase dark:text-white">Enlaces útiles</h2>
                  <ul className="text-gray-400 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                      <NavLink
                    to="/" className="hover:underline">Home</NavLink>
                      </li>
                      <li>
                           <NavLink
                    to="/shop" className="hover:underline">Productos</NavLink>
                      </li>
                  </ul>
              </div>
              <div>
...
SÍGANOS</h2>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-100 sm:text-center dark:text-gray-400">© {year} <a href="https://flowbite.com/" className="hover:underline">Zaparero™</a>.FullStackG24 .
          </span>
